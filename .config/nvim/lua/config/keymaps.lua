...
vim.keymap.set("n", "<C-Up>", "<C-w><Up>", { desc = "Control and arrow keys to switch windows" })
vim.keymap.set("n", "<C-Down>", "<C-w><Down>", { desc = "Control and arrow keys to switch windows" })
vim.keymap.set("n", "<C-Left>", "<C-w><Left>", { desc = "Control and arrow keys to switch windows" })
vim.keymap.set("n", "<C-Right>", "<C-w><Right>", { desc = "Control and arrow keys to switch windows" })
